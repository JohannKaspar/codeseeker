...
args = benchmark.Arguments(
    ...
    experiment_name=("clh-qwen27b-allcodes-full" if FULL else "clh-qwen27b-allcodes-smoke"),
    dataset="mdace-icd10cm",
    base_model=VLLM,
    max_tokens=16384,
    all_codes=True,  # full ~70K catalog — matches faithful RAG-Coding (T-095); removes the label-space confound
    debug=(not FULL),
)
